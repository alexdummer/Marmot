...
namespace Marmot {
  ...
  namespace EigenTensors {
    ...
    typedef Eigen::TensorFixedSize< double, Eigen::Sizes< 3, 3, 3, 3 > > Tensor3333d; ///< Fixed-size 3×3×3×3 double tensor
    ...
    typedef Eigen::TensorFixedSize< double, Eigen::Sizes< 2, 2, 2, 2 > > Tensor2222d; ///< Fixed-size 2×2×2×2 double tensor
    typedef Eigen::TensorFixedSize< double, Eigen::Sizes< 2, 2, 1, 2 > > Tensor2212d; ///< Fixed-size 2×2×1×2 double tensor
    typedef Eigen::TensorFixedSize< double, Eigen::Sizes< 2, 1, 2, 2 > > Tensor2122d; ///< Fixed-size 2×1×2×2 double tensor
    typedef Eigen::TensorFixedSize< double, Eigen::Sizes< 2, 1, 1, 2 > > Tensor2112d; ///< Fixed-size 2×1×1×2 double tensor
