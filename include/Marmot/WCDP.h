...
namespace Marmot::Materials {
   ...
   */
  class WoodCreepDamagePlasticity : public MarmotMaterialHypoElastic {
  public:
    using MarmotMaterialHypoElastic::MarmotMaterialHypoElastic;

    WoodCreepDamagePlasticity( const double* materialProperties, int nMaterialProperties, int materialNumber );
